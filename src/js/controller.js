...
class Controller {
    ...
    initPlayButton () {
        ...
        this.player.template.playButton.addEventListener('click', () => {
            this.player.toggle();
            this.player.options.buttons.playButton.callback && this.player.options.buttons.playButton.callback(this);
        });
    ...
    initScreenshotButton () {
        if (this.player.options.buttons.screenshot) {
    ...
    initSubtitleButton () {
        if (this.player.options.buttons.subtitle) {
